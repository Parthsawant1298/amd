  ...
  const testimonials = [
    {
      ...
      quote: "This AI calendar agent completely transformed how I manage my schedule. I just tell it 'schedule my team standup for tomorrow at 9 AM' and it's done instantly. The natural language processing is incredible!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "The AI understands context so well. When I say 'move my 3 PM meeting to next week', it automatically finds the best available slot and sends updates to all attendees. Pure magic!",
      rating: 5,
      company: "InnovateHub"
    },
    {
      ...
      quote: "Managing a global team's schedules across multiple time zones was a nightmare. Now my AI agent handles it all seamlessly. It even suggests optimal meeting times for everyone involved.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "I manage calendars for 5 executives and this platform is a lifesaver. The AI learns each person's preferences and automatically resolves scheduling conflicts. It's like having a super-smart assistant!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "As a consultant juggling multiple clients, scheduling was my biggest pain point. Now I just chat with my AI agent in plain English and it handles everything - from blocking focus time to scheduling client calls.",
      rating: 5,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
              Discover how professionals worldwide are revolutionizing their productivity with our AI-powered calendar management platform
            </p>
          </div>
