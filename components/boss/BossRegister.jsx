...
const BossRegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/boss/auth/register', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                setTimeout(() => {
                    router.push('/boss/login?registered=true');
                }, 2000);
            } else {
                setErrors(prev => ({
                    ...prev,
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Boss Account Created!</h2>
                        <p className="text-gray-600 mb-4">
                            Your boss account has been successfully created. You will be redirected to the login page.
                        </p>
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600">
                    Or{' '}
                    <Link href="/boss/login" className="font-medium text-blue-600 hover:text-blue-500">
                        sign in to your existing boss account
                    </Link>
                </p>
            </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="w-full">
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-blue-200 focus:outline-none focus:ring-2 text-black transition-colors"
                            >
                                {positions.map(pos => (
                        ...
                        <Button type="submit" disabled={isLoading} loading={isLoading}>
                            {isLoading ? 'Creating Boss Account...' : 'Create Boss Account'}
                        </Button>
                    </form>
                </div>
            </div>
...
export default BossRegisterPage;