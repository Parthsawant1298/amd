...
export default function LowerFooter() {
  return (
    <div className="relative bg-white overflow-hidden">
      <Head>
        <title>AI Scheduling Platform | Transform Your Productivity</title>
        <meta name="description" content="Revolutionary AI-powered scheduling platform with smart calendar automation and productivity features" />
      ...
      <main className="relative z-10 flex items-center justify-center px-4 py-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-lg text-black mb-8">
            Join thousands of users leveraging our AI-powered platform for smarter scheduling, automated reminders, and seamless calendar management.
          </p>
