...
export default function AboutAIScheduling() {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-8 sm:mb-10 md:mb-12">
          <div className="max-w-4xl mb-6 lg:mb-0">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight text-center lg:text-left">
              We offer a wide range of AI-powered features to revolutionize your scheduling experience
            </h2>
          </div>
          <div className="text-center lg:text-right lg:mt-2">
            <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-600 mb-1">100k+</div>
            <div className="text-xs sm:text-sm text-gray-600">Events scheduled with SmartCalendarAI</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <Image
                src="/content.gif"
                alt="AI-powered scheduling dashboard showing smart calendar automation"
                width={600}
                height={100}
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6 order-1 lg:order-2">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 leading-tight text-center lg:text-left">
              Our AI-powered platform delivers next-generation calendar management and productivity solutions.
            </h3>

            {/* Description */}
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed text-center lg:text-left">
              We are committed to transforming how you manage your time with cutting-edge AI technology. Our platform offers smart scheduling, natural language event creation, automated reminders, and seamless integration with Google Calendar. Whether you're a busy professional or a team leader, SmartCalendarAI helps you stay organized, save time, and boost productivity.
            </p>
