            ...
            <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-lg border border-gray-200">
              <div className="mb-8">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700"> Productivity</span>
                </h1>
                <p className="text-gray-600 mt-4">
                  Get in touch to discover how our AI-powered scheduling platform can automate your calendar, boost your productivity, and simplify your day-to-day life.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your scheduling needs, productivity goals, or how we can help..."
                  />
                </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-8">
                  Join thousands of users who trust SmartCalendarAI to automate their schedules, manage reminders, and stay organized. Let's discuss how we can help you work smarter.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@smartcalendarai.com</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 AI Productivity Lane, Mumbai, India</p>
                    <p className="text-sm text-gray-500">Open Mon-Fri, 9AM-6PM IST</p>
                  </div>
                </div>
              </div>
